...
export default function Home() {
  ...
  return (
    <div className="w-screen h-[100vh] overflow-hidden">
      ...
      {toggle && <Carousel current={current} setToggle={setToggle} code='e'/>}
